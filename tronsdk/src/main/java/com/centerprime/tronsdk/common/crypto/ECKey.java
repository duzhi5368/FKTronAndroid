...
package com.centerprime.tronsdk.common.crypto;

import android.util.Log;

import static com.centerprime.tronsdk.common.utils.BIUtil.isLessThan;
import static com.centerprime.tronsdk.common.utils.ByteUtil.bigIntegerToBytes;
...
import com.centerprime.tronsdk.common.crypto.jce.ECKeyAgreement;
import com.centerprime.tronsdk.common.crypto.jce.ECKeyFactory;
import com.centerprime.tronsdk.common.crypto.jce.ECKeyPairGenerator;
import com.centerprime.tronsdk.common.crypto.jce.ECSignatureFactory;
import com.centerprime.tronsdk.common.crypto.jce.TronCastleProvider;
import com.centerprime.tronsdk.common.utils.ByteUtil;
...
public class ECKey implements Serializable {
  ...
  public static ECKey fromPrivate(byte[] privKeyBytes) {
    BigInteger bi = new BigInteger(1,privKeyBytes);
    PrivateKey k =  privateKeyFromBigInteger(bi);

    //BigInteger bi = new BigInteger(1, privKeyBytes);
    return fromPrivate(bi);
  }
